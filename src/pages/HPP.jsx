...
const HPP = () => {
  ...
  const fieldsMap = {
    bahanBaku: [
      ...
      { name: 'totalHarga', label: 'Total Harga', type: 'text', required: true },
    ],
    tenagaKerja: [
      { name: 'namaPekerja', label: 'Nama Pekerja', required: true },
      { name: 'nominalBayaran', label: 'Nominal Bayaran', type: 'text', required: true },
    ],
    beban: [
      { name: 'namaBeban', label: 'Nama Beban', required: true },
      { name: 'nominalBeban', label: 'Nominal Beban', type: 'text', required: true },
    ],
  };
  ...
  const columnsMap = {
    bahanBaku: [
      ...
      { key: 'actions', header: 'Aksi', width: '10%', render: (row) => (
    ...
    <div className="flex h-screen">
      ...
      <div className="flex-1 overflow-auto">
        <div className="p-6 bg-gray-50">
          ...
          <div className="mb-8">
            <div className="flex justify-between items-center mb-2">
              <h2 className="text-lg font-bold">Daftar Biaya Beban (overhead)</h2>
              <Button 
                variant="primary" 
